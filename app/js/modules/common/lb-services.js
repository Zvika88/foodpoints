...
var urlBase = "https://lit-brook-9624.herokuapp.com/api/v1";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.shops.findById() instead.
        "prototype$__findById__shops": {
          url: urlBase + "/users/:id/shops/:fk",
          method: "GET"
        },

        // INTERNAL. Use User.shops.destroyById() instead.
        "prototype$__destroyById__shops": {
          url: urlBase + "/users/:id/shops/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use User.shops.updateById() instead.
        ...
        // INTERNAL. Use User.shops() instead.
        "prototype$__get__shops": {
          isArray: true,
          url: urlBase + "/users/:id/shops",
          method: "GET"
        },

        // INTERNAL. Use User.shops.create() instead.
        "prototype$__create__shops": {
          url: urlBase + "/users/:id/shops",
          method: "POST"
        },

        // INTERNAL. Use User.shops.destroyAll() instead.
        "prototype$__delete__shops": {
          url: urlBase + "/users/:id/shops",
          method: "DELETE"
        },

        // INTERNAL. Use User.shops.count() instead.
        "prototype$__count__shops": {
          url: urlBase + "/users/:id/shops/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use User.transactions.count() instead.
        "prototype$__count__transactions": {
          url: urlBase + "/users/:id/transactions/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Shop.user() instead.
        "::get::shop::user": {
          url: urlBase + "/shops/:id/user",
          method: "GET"
        },
        ...
        // INTERNAL. Use Transaction.creator() instead.
        "::get::transaction::creator": {
          url: urlBase + "/transactions/:id/creator",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.shops
     * @header lbServices.User.shops
     * @object
     * @description
     *
     * The object `User.shops` groups methods
     * manipulating `Shop` instances related to `User`.
     *
     * Call {@link lbServices.User#shops User.shops()}
     * to query all related instances.
     */
        ...
        R.shops = function() {
          ...
          var action = TargetResource["::get::user::shops"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.shops#count
         * @methodOf lbServices.User.shops
         *
         * @description
         *
         * Counts shops of user.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.shops.count = function() {
          var TargetResource = $injector.get("Shop");
          var action = TargetResource["::count::user::shops"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.shops#create
         * @methodOf lbServices.User.shops
         *
         * @description
         *
        ...
        R.shops.create = function() {
          var TargetResource = $injector.get("Shop");
          var action = TargetResource["::create::user::shops"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.shops#destroyAll
         * @methodOf lbServices.User.shops
         *
         * @description
         *
        ...
        R.shops.destroyAll = function() {
          var TargetResource = $injector.get("Shop");
          var action = TargetResource["::delete::user::shops"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.shops#destroyById
         * @methodOf lbServices.User.shops
         *
         * @description
         *
        ...
        R.shops.destroyById = function() {
          var TargetResource = $injector.get("Shop");
          var action = TargetResource["::destroyById::user::shops"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.shops#findById
         * @methodOf lbServices.User.shops
         *
         * @description
         *
        ...
        R.shops.findById = function() {
          var TargetResource = $injector.get("Shop");
          var action = TargetResource["::findById::user::shops"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.shops#updateById
         * @methodOf lbServices.User.shops
         *
         * @description
         *
        ...
        R.shops.updateById = function() {
          var TargetResource = $injector.get("Shop");
          var action = TargetResource["::updateById::user::shops"];
          return action.apply(R, arguments);
        };
     ...
     * @header lbServices.User.transactions
     * @object
     * @description
     *
     * The object `User.transactions` groups methods
     * manipulating `Transaction` instances related to `User`.
     *
     * Call {@link lbServices.User#transactions User.transactions()}
     * to query all related instances.
     */
        ...
        /**
         * @ngdoc method
         * @name lbServices.User.transactions#count
         * @methodOf lbServices.User.transactions
         *
         * @description
         *
         * Counts transactions of user.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.transactions.count = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::count::user::transactions"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.shops.destroyById() instead.
        "::destroyById::user::shops": {
          url: urlBase + "/users/:id/shops/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use User.shops.updateById() instead.
        "::updateById::user::shops": {
          url: urlBase + "/users/:id/shops/:fk",
          method: "PUT"
        },
    ...
    */
    R.modelName = "Shop";
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::shop::user"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Transaction";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Transaction#creator
         * @methodOf lbServices.Transaction
         *
         * @description
         *
        ...
        R.creator = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::transaction::creator"];
          return action.apply(R, arguments);
        };
